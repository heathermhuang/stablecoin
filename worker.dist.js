...
.tnav-logo{width:32px;height:32px;background:linear-gradient(135deg,#22c55e,#0891b2);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:16px;font-family:'IBM Plex Mono',monospace;font-weight:800;box-shadow:0 2px 8px rgba(34,197,94,0.25)}
...
tbody tr:hover{background:rgba(255,255,255,0.025);border-left:2px solid rgba(34,197,94,0.35)}
tbody tr:hover td:first-child{padding-left:12px}
tbody tr:last-child td{border-bottom:none}

/* CELLS */
.tk{display:flex;align-items:center;gap:10px}
.tk-ico{width:28px;height:28px;border-radius:50%;background:var(--bg-3);border:1px solid var(--border-2);display:flex;align-items:center;justify-content:center;font-family:'IBM Plex Mono',monospace;font-size:9px;font-weight:700;color:var(--text-2);flex-shrink:0;overflow:hidden;box-shadow:0 0 0 1px rgba(255,255,255,0.05)}
.tk-ico img{width:28px;height:28px;border-radius:50%;display:block}
...
@media(max-width:640px){
  ...
  .col-mcap,.col-vol,.col-chg,.col-chains,.col-exchanges{display:none}
...
<nav class="topnav">
  <div class="topnav-inner">
    <a class="tnav-brand" href="https://shitcoin.io">
      ...
      <span class="tnav-name">Stablecoin Monitor</span>
    </a>
...
const HARDCODED = [
  { llamaId: '1',   sym: 'USDT',   name: 'Tether',            cgId: 'tether',               mech: 'fiat',  chains_hint: 20,
    ...
    exchanges: ['binance','coinbase','kraken','okx','bybit','bitfinex','kucoin','gate'] },
  { llamaId: '2',   sym: 'USDC',   name: 'USD Coin',          cgId: 'usd-coin',             mech: 'fiat',  chains_hint: 15,
    ...
    exchanges: ['binance','coinbase','kraken','okx','bybit','kucoin','bitget'] },
  { llamaId: '4',   sym: 'DAI',    name: 'Dai',               cgId: 'dai',                  mech: 'cdp',   chains_hint: 12,
    icon: 'https://coin-images.coingecko.com/coins/images/9956/small/Badge_Dai.png',
    exchanges: ['coinbase','kraken','binance','okx','kucoin','gate'] },
  { llamaId: '149', sym: 'USDE',   name: 'USDe',              cgId: 'ethena-usde',          mech: 'cdp',   chains_hint: 5,
    icon: 'https://coin-images.coingecko.com/coins/images/33613/small/USDE.png',
    exchanges: ['binance','okx','bybit','kucoin','bitget'] },
  { llamaId: '161', sym: 'FDUSD',  name: 'First Digital USD', cgId: 'first-digital-usd',    mech: 'fiat',  chains_hint: 3,
    icon: 'https://coin-images.coingecko.com/coins/images/31079/small/firstfigital.png',
    exchanges: ['binance'] },
  { llamaId: '5',   sym: 'FRAX',   name: 'Frax',              cgId: 'frax',                 mech: 'algo',  chains_hint: 12,
    icon: 'https://coin-images.coingecko.com/coins/images/13422/small/FRAX_icon.png',
    exchanges: ['okx','gate','kucoin'] },
  { llamaId: '6',   sym: 'TUSD',   name: 'TrueUSD',           cgId: 'true-usd',             mech: 'fiat',  chains_hint: 5,
    icon: 'https://coin-images.coingecko.com/coins/images/3449/small/tusd.png',
    exchanges: ['binance','okx','kucoin','gate'] },
  { llamaId: '146', sym: 'PYUSD',  name: 'PayPal USD',        cgId: 'paypal-usd',           mech: 'fiat',  chains_hint: 2,
    icon: 'https://coin-images.coingecko.com/coins/images/31212/small/PYUSD.png',
    exchanges: ['coinbase','kraken'] },
  { llamaId: '8',   sym: 'USDD',   name: 'USDD',              cgId: 'usdd',                 mech: 'algo',  chains_hint: 4,
    icon: 'https://coin-images.coingecko.com/coins/images/25380/small/USDD.png',
    exchanges: ['bybit','okx','kucoin','gate','bitget'] },
  { llamaId: '7',   sym: 'USDP',   name: 'Pax Dollar',        cgId: 'paxos-standard',       mech: 'fiat',  chains_hint: 2,
    icon: 'https://coin-images.coingecko.com/coins/images/6013/small/Pax_Dollar.png',
    exchanges: ['kraken','bitfinex'] },
  { llamaId: '9',   sym: 'GUSD',   name: 'Gemini Dollar',     cgId: 'gemini-dollar',        mech: 'fiat',  chains_hint: 2,
    icon: 'https://coin-images.coingecko.com/coins/images/5992/small/gemini-dollar-gusd.png',
    exchanges: ['kraken','bitfinex'] },
  { llamaId: '11',  sym: 'LUSD',   name: 'Liquity USD',       cgId: 'liquity-usd',          mech: 'cdp',   chains_hint: 3,
    icon: 'https://coin-images.coingecko.com/coins/images/14666/small/Group_3.png',
    exchanges: ['kraken','kucoin','gate'] },
  { llamaId: '133', sym: 'GHO',    name: 'GHO',               cgId: 'gho',                  mech: 'cdp',   chains_hint: 2,
    icon: 'https://coin-images.coingecko.com/coins/images/30663/small/gho-token-logo.png',
    exchanges: ['kraken','okx'] },
  { llamaId: '132', sym: 'crvUSD', name: 'Curve USD',         cgId: 'crvusd',               mech: 'cdp',   chains_hint: 1,
    icon: 'https://coin-images.coingecko.com/coins/images/30118/small/crvusd.png',
    exchanges: ['okx','gate'] },
  { llamaId: '10',  sym: 'sUSD',   name: 'Synthetix USD',     cgId: 'nusd',                 mech: 'cdp',   chains_hint: 2,
    icon: 'https://coin-images.coingecko.com/coins/images/5013/small/sUSD.png',
    exchanges: ['kraken','kucoin'] },
  { llamaId: '12',  sym: 'MIM',    name: 'Magic Internet $',  cgId: 'magic-internet-money', mech: 'cdp',   chains_hint: 7,
    icon: 'https://coin-images.coingecko.com/coins/images/16786/small/mimlogopng.png',
    exchanges: ['gate','kucoin'] },
  { llamaId: '3',   sym: 'BUSD',   name: 'Binance USD',       cgId: 'binance-usd',          mech: 'fiat',  chains_hint: 3,
    icon: 'https://coin-images.coingecko.com/coins/images/9576/small/BUSD.png',
    exchanges: ['binance'] },
  { llamaId: '15',  sym: 'UST',    name: 'TerraUSD (Classic)',cgId: 'terrausd',             mech: 'algo',  chains_hint: 2, depegged: true,
    icon: 'https://coin-images.coingecko.com/coins/images/21150/small/UST.png',
    exchanges: [] },
  { llamaId: '23',  sym: 'EURS',   name: 'STASIS EURO',       cgId: 'stasis-eurs',          mech: 'fiat',  chains_hint: 2,
    icon: 'https://coin-images.coingecko.com/coins/images/5164/small/EURS_300x300.png',
    exchanges: ['kraken','bitfinex','gate'] },
  { llamaId: '29',  sym: 'EURT',   name: 'Euro Tether',       cgId: 'tether-eurt',          mech: 'fiat',  chains_hint: 2,
    icon: 'https://coin-images.coingecko.com/coins/images/17385/small/Tether_logo.png',
    exchanges: ['kraken','bitfinex'] },
];
...
// ── Chain icons + block explorer links ──────────────────────────────────────
const CHAIN_SLUG = {
  'Ethereum':'ethereum','BSC':'bsc','Tron':'tron','Solana':'solana',
  'Arbitrum':'arbitrum','Polygon':'polygon','Optimism':'optimism',
  'Avalanche':'avalanche','Base':'base','Fantom':'fantom','Algorand':'algorand',
  'Near':'near','Stellar':'stellar','Cosmos':'cosmos','Aptos':'aptos',
  'Sui':'sui','Celo':'celo','Gnosis':'gnosis','Moonbeam':'moonbeam',
  'zkSync Era':'zksync-era','Linea':'linea','Scroll':'scroll',
  'Manta':'manta','Mantle':'mantle','Blast':'blast','TON':'ton',
  'Cardano':'cardano','Hedera':'hedera',
};

// Contract addresses per coin per chain → block explorer link
const CONTRACTS = {
  USDT:{
    ...
    Optimism:'https://optimistic.etherscan.io/token/0x94b008aA00579c1307B0EF2c499aD98a8ce58e58',
    Base:'https://basescan.org/token/0xfde4C96c8593536E31F229EA8f37b2ADa2699bb2',
    TON:'https://tonscan.org/jetton/EQCxE6mUtQJKFnGfaROTKOt1lZbDiiX1kCixRv7Nw2Id_sDs',
  ...
  USDC:{
    ...
    Polygon:'https://polygonscan.com/token/0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359',
    ...
    Avalanche:'https://snowtrace.io/token/0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E',
    Tron:'https://tronscan.org/#/token20/TEkxiTehnzSmse5XcPKcc89f2jFPPtRGUW',
  },
  DAI:{
    Ethereum:'https://etherscan.io/token/0x6B175474E89094C44Da98b954EedeAC495271d0F',
    ...
    Arbitrum:'https://arbiscan.io/token/0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1',
    Optimism:'https://optimistic.etherscan.io/token/0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1',
    Base:'https://basescan.org/token/0x50c5725949A6F0c72E6C4a641F24049A917DB0Cb',
    Gnosis:'https://gnosisscan.io/token/0xe91D153E0b41518A2Ce8Dd3D7944Fa863463a97d',
    Avalanche:'https://snowtrace.io/token/0xd586E7F844cEa2F87f50152665BCbc2C279D8d70',
  },
  USDE:{
    Ethereum:'https://etherscan.io/token/0x4c9EDD5852cd905f086C759E8383e09bff1E68B3',
    Arbitrum:'https://arbiscan.io/token/0x5d3a1Ff2b6BAb83b63cd9AD0787074081a52ef34',
    Base:'https://basescan.org/token/0x5d3a1Ff2b6BAb83b63cd9AD0787074081a52ef34',
    Mantle:'https://explorer.mantle.xyz/token/0x5d3a1Ff2b6BAb83b63cd9AD0787074081a52ef34',
  },
  FDUSD:{
    Ethereum:'https://etherscan.io/token/0xc5f0f7b66764F6ec8C8Dff7BA683102295E16409',
    BSC:'https://bscscan.com/token/0xc5f0f7b66764F6ec8C8Dff7BA683102295E16409',
  },
  FRAX:{
    Ethereum:'https://etherscan.io/token/0x853d955aCEf822Db058eb8505911ED77F175b99e',
    Arbitrum:'https://arbiscan.io/token/0x17FC002b466eEc40DaE837Fc4bE5c67993ddBd6F',
    Polygon:'https://polygonscan.com/token/0x45c32fA6DF82ead1e2EF74d17b76547EDdFaFF89',
    Optimism:'https://optimistic.etherscan.io/token/0x2E3D870790dC77A83DD1d18184Acc7439A53f475',
    Avalanche:'https://snowtrace.io/token/0xD24C2Ad096400B6FBcd2ad8B24E7acBc21A1da64',
    BSC:'https://bscscan.com/token/0x90C97F71E18723b0Cf0dfa30ee176Ab653E89F40',
  },
  LUSD:{
    Ethereum:'https://etherscan.io/token/0x5f98805A4E8be255a32880FDeC7F6728C6568bA0',
    Arbitrum:'https://arbiscan.io/token/0x93b346b6BC2548dA6A1E7d98E9a421B42541425b',
    Optimism:'https://optimistic.etherscan.io/token/0xc40F949F8a4e094D1b49a23ea9241D289B7b2819',
  },
  crvUSD:{
    Ethereum:'https://etherscan.io/token/0xf939E0A03FB07F59A73314E73794Be0E57ac1b4E',
  },
  GHO:{
    Ethereum:'https://etherscan.io/token/0x40D16FC0246aD3160Ccc09B8D0D3A2cD28aE6C2f',
    Arbitrum:'https://arbiscan.io/token/0x7dfF72693f6A4149b17e7C6314655f6A9F7c8B33',
  },
  MIM:{
    Ethereum:'https://etherscan.io/token/0x99D8a9C45b2ecA8864373A26D1459e3Dff1e17F3',
    BSC:'https://bscscan.com/token/0xfE19F0B51438fd612f6FD59C1dbB3eA319f433Ba',
    Arbitrum:'https://arbiscan.io/token/0xFEa7a6a0B346362BF88A9e4A88416B77a57D6c2A',
    Avalanche:'https://snowtrace.io/token/0x130966628846BFd36ff31a822705796e8cb8C18D',
    Fantom:'https://ftmscan.com/token/0x82f0B8B456c1A451378467398982d4834b6829c1',
  },
  sUSD:{
    Ethereum:'https://etherscan.io/token/0x57Ab1ec28D129707052df4dF418D58a2D46d5f51',
    Optimism:'https://optimistic.etherscan.io/token/0x8c6f28f2F1A3C87F0f938b96d27520d9751ec8d9',
  },
  USDD:{
    Tron:'https://tronscan.org/#/token20/TPYmHEhy5n8TCEfYGqW2rPxsghSfzghPDn',
    Ethereum:'https://etherscan.io/token/0x0C10bF8FcB7Bf5412187A595ab97a3609160b5c6',
    BSC:'https://bscscan.com/token/0xd17479997F34dd9156Deef8d7A31c301560754B',
  },
  GUSD:{
    Ethereum:'https://etherscan.io/token/0x056Fd409E1d7A124BD7017459dFEa2F387b6d5Cd',
  },
  USDP:{
    Ethereum:'https://etherscan.io/token/0x8E870D67F660D95d5be530380D0eC0bd388289E1',
  },
  PYUSD:{
    Ethereum:'https://etherscan.io/token/0x6c3ea9036406852006290770BEdFcAbA0e23A0e8',
    Solana:'https://solscan.io/token/2b1kV6DkPAnxd5ixfnxCpjxmKwqjjaYmCZfHsFu24GXo',
  },
};

// Fallback: DeFi Llama stablecoin page (has all chains + contracts)
function chainContractUrl(sym, chain) {
  return (CONTRACTS[sym] && CONTRACTS[sym][chain]) ||
    \`https://defillama.com/stablecoin/\${sym.toLowerCase()}\`;
}

function chainIconsHtml(chains, sym, max = 6) {
  if (!chains || chains.length === 0) return '<span class="chain-more">—</span>';
  const show = chains.slice(0, max);
  const extra = chains.length - show.length;
  const icons = show.map(ch => {
    const slug = CHAIN_SLUG[ch] || ch.toLowerCase().replace(/\\s+/g,'-');
...
// ── Exchange icons + market links ────────────────────────────────────────────
const EX_META = {
  binance:  { name:'Binance',  domain:'binance.com',  url: s => \`https://www.binance.com/en/price/\${s}\` },
  coinbase: { name:'Coinbase', domain:'coinbase.com', url: s => \`https://www.coinbase.com/price/\${s}\` },
  kraken:   { name:'Kraken',   domain:'kraken.com',   url: s => \`https://www.kraken.com/en-us/prices/\${s}\` },
  okx:      { name:'OKX',      domain:'okx.com',      url: s => \`https://www.okx.com/web3/detail/usdt/\${s}\` },
  bybit:    { name:'Bybit',    domain:'bybit.com',    url: s => \`https://www.bybit.com/en/coin-price/\${s}/\` },
  bitfinex: { name:'Bitfinex', domain:'bitfinex.com', url: s => \`https://trading.bitfinex.com/t/\${s.toUpperCase()}:USD\` },
  kucoin:   { name:'KuCoin',   domain:'kucoin.com',   url: s => \`https://www.kucoin.com/price/\${s}\` },
  bitget:   { name:'Bitget',   domain:'bitget.com',   url: s => \`https://www.bitget.com/price/\${s}\` },
  gate:     { name:'Gate.io',  domain:'gate.io',      url: s => \`https://www.gate.io/price/\${s}\` },
  upbit:    { name:'Upbit',    domain:'upbit.com',    url: s => \`https://upbit.com/exchange?code=CRIX.UPBIT.USD-\${s.toUpperCase()}\` },
};

function exchangeBadgesHtml(exchanges, sym, cgId) {
  if (!exchanges || exchanges.length === 0) return '<span style="color:var(--text-3);font-size:11px">—</span>';
  const slug = cgId || sym.toLowerCase();
  return \`<div class="ex-badges">\${exchanges.map(ex => {
    const m = EX_META[ex];
    if (!m) return '';
...
function renderTable() {
  ...
  if (page.length === 0) {
    tbody.innerHTML = \`<tr><td colspan="11"><div class="empty-state">No stablecoins match your filter.</div></td></tr>\`;
  ...
  tbody.innerHTML = page.map(c => {
    ...
    return \`<tr>
      ...
      <td class="col-chains">\${chainIconsHtml(c.chains, c.sym, 6)}</td>
      <td class="col-exchanges">\${exchangeBadgesHtml(c.exchanges, c.sym, c.cgId)}</td>
