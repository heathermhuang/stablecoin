...
@media(max-width:640px){.tnav-name{display:none}.tnav-divider{display:none}.tnav-tabs{justify-content:flex-start}.tnav-tab{padding:6px 14px;font-size:12px}.topnav-inner{padding:0 14px}.col-mcap,.col-vol,.col-chg,.col-chains,.col-exchanges{display:none}table{min-width:520px}}
